...
ag {
  ...
  ROOT ag = f32[128,128]{0,1} all-gather(input),
    replica_groups={}, dimensions={1}, channel_id=1337
}

ag2 {
  input = f32[128,128]{0,1} parameter(0)
  ROOT ag = f32[128,128]{0,1} all-gather(input),
    replica_groups={}, dimensions={1}, channel_id=1337
}
...
ENTRY main {
  input = f32[128,32]{0,1} parameter(0)
  ag = f32[128,128]{0,1} call(input), to_apply=ag
  ag2 = f32[128,128]{0,1} call(ag), to_apply=ag2
  ROOT result = (f32[128,128]{0,1}, f32[128,128]{0,1}) tuple(ag2, ag)
})";
